...
return new class () extends Migration {
    ...
    public function up(): void
    {
        Schema::create('products_variants_warehouse_channel_price_history', function (Blueprint $table) {
            ...
            $table->foreign('product_variants_warehouse_id', 'variant_warehouse_channel_ref')->references('id')->on('products_variants_warehouses');
            $table->index('created_at' ,'created_at_index');
            $table->index('from_date', 'from_date_index');
        });
