 ...
 *     — no --app_id, so it runs for every app whose operator switched the feature on. Tagging an
 *       account does not enroll its app; on an app that already said yes, a newly tagged account is
 *       picked up on the next run without editing this file.
 *
