...
class DiscountManagementMutation
{
    ...
    public function create(mixed $root, array $request): Discount
    {
        ...
        $data = new DiscountData(
            ...
            start_date: isset($request['input']['start_date']) ? new DateTime($request['input']['start_date']) : null,
            end_date: isset($request['input']['end_date']) ? new DateTime($request['input']['end_date']) : null,
