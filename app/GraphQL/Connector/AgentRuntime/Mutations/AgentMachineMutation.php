...
use Kanvas\Connectors\AgentRuntime\Actions\PingAgentMachineAction;
use Kanvas\Connectors\AgentRuntime\Jobs\UpdateAgentRuntimeOnMachineJob;
...
class AgentMachineMutation
{
    ...
    public function updateContainers(mixed $root, array $request): bool
    {
        ...
        UpdateAgentRuntimeOnMachineJob::dispatch($machine);
