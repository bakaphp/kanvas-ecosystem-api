...
final class CompanyDefaultRegionTest extends TestCase
{
    ...
    {
        $global = $this->makeGlobalRegion($this->appInstance, 'test-company-default-sv', 'TCDSV');
    ...
    {
        $foreign = $this->makeGlobalRegion($this->appInstance, 'test-company-default-foreign', 'TCDFO');
    ...
    {
        $global = $this->makeGlobalRegion($this->appInstance, 'test-company-default-backfill', 'TCDBF');
