...
class AgentMachineCrudTest extends TestCase
{
    ...
    public function testCreateAgentMachine(): void
    {
        ...
        $this->graphQL('
            mutation($input: AgentMachineInput!) {
                agentRuntimeCreateMachine(input: $input) {
                    id
                    name
                    host
                    ssh_port
    ...
    public function testUpdateAgentMachine(): void
    {
        ...
        $this->graphQL('
            mutation($id: ID!, $input: UpdateAgentMachineInput!) {
                agentRuntimeUpdateMachine(id: $id, input: $input) {
                    id
                    name
                    max_agents
                    is_active
    ...
    public function testDeleteAgentMachine(): void
    {
        ...
        $this->graphQL('
            mutation($id: ID!) {
                agentRuntimeDeleteMachine(id: $id)
            }
        ', ['id' => $machine->getId()])
        ->assertSuccessful()
        ->assertJson(['data' => ['agentRuntimeDeleteMachine' => true]]);
    }
