...
final class AppleInAppPurchaseTest extends TestCase
{
    ...
    public function testAppleInAppPurchaseReceiptChannel()
    {
        ...
        $result = $activity->execute($order, $app, ['company' => $company]);
