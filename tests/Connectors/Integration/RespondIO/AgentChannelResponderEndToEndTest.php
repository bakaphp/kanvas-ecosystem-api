...
class AgentChannelResponderEndToEndTest extends TestCase
{
    ...
    public function testInboundRespondIoTriggersAgentReplyPersistedOnChannel(): void
    {
        Http::fake();
        ...
        $messageType = MessageType::firstOrCreate(
            ['apps_id' => $app->getId(), 'languages_id' => 1, 'verb' => 'respondio-text'],
            ['name' => 'RespondIO Text']
        );
        ...
        $channel = Channel::firstOrCreate(
            [
                ...
                'slug' => SessionChannelService::createChannelSlug('respondio', '19998887777'),
            ],
            ['name' => 'RespondIO Test', 'description' => 'Test RespondIO channel', 'users_id' => $user->getId()]
        );
        ...
        $inbound = Message::factory()
            ...
            ->create([
                'message' => [
                    'content' => 'Hello from RespondIO',
                    'chat_jid' => '+19998887777',
                    'from_me' => false,
                ],
                'is_locked' => 0,
                'is_un_response' => 0,
        ...
        $session = new CreateSessionAction(
            SessionDto::from([
                ...
                'entity_id' => $lead->getId(),
                'canal_id' => SessionChannelService::createCanalId('respondio', '19998887777'),
                'user' => [
        ...
        try {
            ...
            // Outbound RespondIO API call may throw in test env — persistence ran first.
        }
