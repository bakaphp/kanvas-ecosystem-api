...
trait HasDealerSocketConfiguration
{
    public function setupDealerSocketConfiguration(Companies $company, Apps $app): void
    {
    ...
    public function setupDealerSocketIntegration(Companies $company, Regions $region): ModelsIntegrationsCompany
    {
        $credentials = [
            'publicKey' => env('TEST_DEALER_SOCKET_PUBLIC_KEY'),
            'privateKey' => env('TEST_DEALER_SOCKET_PRIVATE_KEY'),
