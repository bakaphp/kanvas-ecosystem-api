...
class InAppPurchaseAppleOrderTest extends TestCase
{
    ...
    public function testCreateOrderFromAppleInAppPurchaseWithCustomFieldsVariants()
    {
        $app = app(Apps::class);
        $user = auth()->user();
        $company = $user->getCurrentCompany();
        ...
        // Prepare input data for the mutation
        $productId = 'apple_var_' . fake()->uuid();
        $variantSku = 'variant_apple_' . fake()->uuid();
        $receipt = [
            'product_id' => $productId,
            'transaction_id' => '2000000778751927',
            'receipt' => '',
        ...
        $this->assertCount(2, OrderItem::where('order_id', $response->json('data.createOrderFromAppleInAppPurchase.id'))->get());
    }
}
