...
namespace Tests\GraphQL\Connector\AgentRuntime;
...
class AgentRuntimeDeploymentCommandTest extends TestCase
{
    ...
    public function testExecCommandWithAppKey(): void
    {
        ...
        $response->assertJson(['data' => ['agentRuntimeExecCommand' => true]]);
    ...
    public function testGetConfigRequiresAppKey(): void
    {
        $this->graphQL('
            mutation {
                agentRuntimeGetConfig(deployment_id: "1")
            }
        ')->assertGraphQLErrorMessage('Unauthenticated.');
    }
