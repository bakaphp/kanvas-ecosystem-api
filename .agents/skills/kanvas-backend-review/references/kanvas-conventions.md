...
Skills carry rules too. If the diff scaffolds a CRUD, a connector, or an `@search` query, the matching skill under `.agents/skills/` is the spec that change should have followed.
