...
use Kanvas\Wallet\Models\Wallets as KanvasWallet;
use Kanvas\Wallet\Models\WalletsTransactions as KanvasWalletsTransactions;
use Kanvas\Wallet\Models\WalletsTransactionsLogs as KanvasWalletsTransactionsLogs;
...
return [
    ...
    'transaction' => [
         ...
         * @see Transaction
         */
        'model' => KanvasWalletsTransactions::class,
    ],
    ...
    'transfer' => [
         ...
         * @see Transfer
         */
        'model' => KanvasWalletsTransactionsLogs::class,
    ],
