...
class UsersRepository
{
    ...
    {
        return Users::select('users.*')->join('users_associated_apps', 'users_associated_apps.users_id', 'users.id')
    ...
    {
        try {
            return Users::select('users.*')->join('users_associated_company', 'users_associated_company.users_id', 'users.id')
