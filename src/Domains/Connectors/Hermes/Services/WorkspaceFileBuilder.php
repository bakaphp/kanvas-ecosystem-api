 ...
 *
 * These files are written to ~/.hermes/workspace/ inside the agent's container.
 * Hermes reads them at runtime to configure the agent's persona, instructions, and tools.
 *
 * Files generated:
