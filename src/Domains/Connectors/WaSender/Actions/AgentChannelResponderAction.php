...
class AgentChannelResponderAction
{
    ...
    {
        if ($this->message->app->get('allow_session_hijack', false)
          && $this->message->app->get('overwrite_phone_number') !== null
        ) {
            $overwriteConfig = $this->message->app->get('overwrite_phone_number');
