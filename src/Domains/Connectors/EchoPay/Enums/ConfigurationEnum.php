...
enum ConfigurationEnum: string
{
    ...
    case AUTHORIZE_PAYMENT_PATH = '/api/v2/echo-pay/cybersource-payment/authorize';
    case CAPTURE_PAYMENT_PATH = '/api/v2/echo-pay/cybersource-payment/capture';
    case REVERSAL_PAYMENT_PATH = '/api/v2/echo-pay/cybersource-payment/reversal';
}
