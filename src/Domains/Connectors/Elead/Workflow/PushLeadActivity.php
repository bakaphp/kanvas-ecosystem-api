...
#[WorkflowAction(
    name: 'Elead Push Lead',
    description: 'Pushes the lead into Elead so the CRM has it. Outbound one-way sync — it writes to Elead and '
        . 'does not bring anything back, and it does not contact the customer. Only useful if this '
        . 'company actually runs Elead; several connectors ship a near-identical step, so pick the one '
        . 'matching the CRM the company uses.',
