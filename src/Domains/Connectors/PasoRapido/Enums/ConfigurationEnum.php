...
enum ConfigurationEnum: string
{
    ...
    case VERIFY_MAX_ATTEMPTS_CORPORATE = 'PASO_RAPIDO_VERIFY_MAX_ATTEMPTS_CORPORATE';
    case VERIFY_MAX_DAILY = 'PASO_RAPIDO_VERIFY_MAX_DAILY';
    case VERIFY_MAX_DAILY_CORPORATE = 'PASO_RAPIDO_VERIFY_MAX_DAILY_CORPORATE';
    case VERIFY_SEQUENTIAL_THRESHOLD = 'PASO_RAPIDO_VERIFY_SEQUENTIAL_THRESHOLD';
    case VERIFY_SEQUENTIAL_THRESHOLD_CORPORATE = 'PASO_RAPIDO_VERIFY_SEQUENTIAL_THRESHOLD_CORPORATE';
    ...
    case VERIFY_IP_MAX_DAILY_CORPORATE = 'PASO_RAPIDO_VERIFY_IP_MAX_DAILY_CORPORATE';
    case VERIFY_IP_MAX_USERS = 'PASO_RAPIDO_VERIFY_IP_MAX_USERS';
    case VERIFY_IP_MAX_USERS_CORPORATE = 'PASO_RAPIDO_VERIFY_IP_MAX_USERS_CORPORATE';
