...
final class PullAcumaticaFiscalPeriodsJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        return [
            new WithoutOverlapping('acumatica-periods-' . (string) $this->company->getId()),
        ];
    }
