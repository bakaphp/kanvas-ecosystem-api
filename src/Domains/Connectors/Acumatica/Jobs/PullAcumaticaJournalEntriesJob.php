...
final class PullAcumaticaJournalEntriesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        return [
            new WithoutOverlapping('acumatica-journal-entries-' . (string) $this->company->getId()),
        ];
    }
