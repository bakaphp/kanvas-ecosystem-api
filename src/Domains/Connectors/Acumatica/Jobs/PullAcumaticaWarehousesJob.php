...
final class PullAcumaticaWarehousesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        return [
            new WithoutOverlapping('acumatica-warehouses-' . (string) $this->company->getId()),
        ];
    }
