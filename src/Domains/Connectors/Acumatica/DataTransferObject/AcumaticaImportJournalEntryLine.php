...
/**
 * One line of an Acumatica GL batch (dbo.GLTran, joined to Account for AccountCD). Account
 * resolution (AccountCD → Kanvas account id) happens in PullJournalEntriesAction.
 */
