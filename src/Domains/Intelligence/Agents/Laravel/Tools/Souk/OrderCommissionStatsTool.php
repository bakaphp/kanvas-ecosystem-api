...
class OrderCommissionStatsTool implements KanvasToolInterface
{
    ...
    {
        return 'Revenue split for commissioned orders: gross revenue, platform commission earned, and provider '
            . 'payout owed, plus the order count. Optional date range and order-type filter. Use for "how much '
            . 'commission did we earn", "what do we owe provider X", marketplace take-rate questions. Counts only '
            . 'orders with a commission configured, anchored on order creation date.';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        return json_encode(
            new OrderReportService($this->app, $this->company)->commissionStats(
                $orderTypes,
