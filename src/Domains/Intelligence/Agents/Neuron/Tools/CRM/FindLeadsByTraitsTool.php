    ...
    protected function properties(): array
    {
        return [
            ...
            new ToolProperty(
                ...
                description: 'Product or variant text, SKU, EAN or barcode, e.g. "RAV4", "2025 Tacoma", or "truck".',
                required: false,
            ),
            new ArrayProperty(
            ...
            new ToolProperty(
                ...
                description: 'Minimum recorded price when the lead expressed interest.',
                required: false,
            ),
            new ToolProperty(
                name: 'maximum_variant_price',
                type: PropertyType::NUMBER,
                description: 'Maximum recorded price when the lead expressed interest, e.g. 30000.',
                required: false,
            ),
            new ToolProperty(
                name: 'engagement_action',
                type: PropertyType::STRING,
                description: 'Engagement action or alias, e.g. trade-in, add-trade, credit-app, get-docs, or esign-docs.',
                required: false,
            ),
            new ToolProperty(
                name: 'engagement_completion',
                type: PropertyType::STRING,
                description: 'Engagement state: started, incomplete, submitted, or missing. Incomplete means the latest state for an engagement entity is not submitted.',
                required: false,
            ),
            new ToolProperty(
                name: 'communication_state',
                type: PropertyType::STRING,
                description: 'Communication state: awaiting_team_response, responded, never_replied, or no_messages.',
                required: false,
            ),
            new ToolProperty(
                name: 'customer_waiting_since_days',
                type: PropertyType::INTEGER,
                description: 'For awaiting_team_response, require the latest inbound customer message to be at least this many days old.',
                required: false,
            ),
