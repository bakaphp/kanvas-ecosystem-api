    ...
    protected function properties(): array
    {
        return [
            ...
            new ToolProperty(
                ...
                description: 'File name to store it under, including extension — e.g. "spec-sheet.md". Defaults '
                    . 'to the URL\'s own file name, or agent-document.md for inline content.',
                required: false,
            ),
            new ToolProperty(
                name: 'content',
