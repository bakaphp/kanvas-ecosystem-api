...
class AccountsPayableAgent extends SystemUserAgent
{
    ...
    private function apGuidance(): string
    {
        return implode("\n", [
            ...
            . 'Pass vendor_name exactly as extract_invoice_data\'s own vendor_name field came back — copy it '
            . 'verbatim, never retype it from memory or from what the email body/signature says; a name that '
            . 'differs even slightly can fuzzy-match a completely different, unrelated existing vendor. '
