...
/**
 * Which history store DescribeMessageAttachmentsJob writes the backfilled descriptions back to.
 * The agent histories live in different tables, so the job needs to know which one.
 */
