...
class GetMessagesTool extends Tool
{
    ...
    public function outputSchema(JsonSchema $schema): array
    {
        ...
        $messageSchema = $schema->object([
            ...
            'children' => $schema->array($schema->ref('#/definitions/message'))->description('Child messages'),
            'user' => $schema->object([
                'id' => $schema->integer()->description('User ID'),
                'displayname' => $schema->string()->description('Display name'),
        ...
        return [
            ...
            'meta' => $schema->object([
                ...
                'message_type' => $schema->object([
                    'id' => $schema->integer()->description('Message type ID'),
                    'name' => $schema->string()->description('Message type name'),
                    'verb' => $schema->string()->description('Message type verb'),
                ])->description('The message type filter applied'),
